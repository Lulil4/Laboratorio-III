...
//AGREGAR COLUMNA 'ACCION'
		foreach ($ArrayDeProductos as $prod){
			...
			$grilla .= "<tr>
							...
							<td>
								<input type='button' class='MiBotonUTN' value='Eliminar' onclick='Main.EliminarProducto(".$prod->getCodBarra().")' />
								<input type='button' class='MiBotonUTN' value='Modificar' onclick='Main.ModificarProducto(".$prod->getCodBarra().",`".$prod->getNombre()."`)' />
							</td>
						</tr>";
